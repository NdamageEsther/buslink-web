...
const menuItems = [
  ...
  {
    label: "Passengers", path: "/driver/passengers",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
  },
  {
    label: "Scan Ticket", path: "/driver/scan",
  ...
  {
    label: "Trip Reports", path: "/driver/reports",
...
export default function DriverLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div style={{
      ...
      {/* ── SHARED PUBLIC NAVBAR (Landing Page style) ── */}
      <Navbar />
      ...
      <div style={{ display: "flex", flex: 1 }}>
        ...
        <aside style={{
            ...
            {sidebarOpen && (
              <div style={{ display: "flex", alignItems: "center", gap: "8px", overflow: "hidden" }}>
                ...
                <div style={{ overflow: "hidden" }}>
                  ...
                  <div style={{ fontSize: "10px", color: "#60a5fa", fontWeight: "600" }}>Driver</div>
                </div>
              </div>
            )}
            <button
              onClick={() => setSidebarOpen(o => !o)}
              style={{ padding: "5px", border: "none", background: "transparent", cursor: "pointer", color: "#64748b", flexShrink: 0 }}
          ...
          <nav style={{
            ...
            {menuItems.map(item => {
              ...
              return (
                ...
                >
                  <span style={{ flexShrink: 0, color: active ? "#fff" : "#475569" }}>
                    {item.icon}
                  </span>
          ...
          <div style={{ padding: "10px 8px", borderTop: "1px solid #1e293b", display: "flex", flexDirection: "column", gap: "6px" }}>
            {sidebarOpen && (
              <div style={{
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          <footer style={{ backgroundColor: "#fff", borderTop: "1px solid #e2e8f0", padding: "14px 24px", textAlign: "center" }}>
            <p style={{ fontSize: "13px", color: "#94a3b8", margin: 0 }}>
              © 2026 BusLink — Rwanda Smart Bus Ticketing Platform
            </p>
          </footer>
        </div>
      </div>
